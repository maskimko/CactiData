...
@ManagedBean(name = "isxPollerItemController")
@SessionScoped
public class ISXPollerItemController implements Serializable {
    ...
    public ISXPollerItemController() {
    }
    ...
    private ISXPollerItemFacade getFacade() {
        return ejbFacade;
    }
