...
import ua.pp.msk.learn.javaee.cacti.ejb.PollerItemFacade;
...
@ManagedBean(name = "pollerItemController")
@SessionScoped
public class PollerItemController implements Serializable {

    private int pageSize = 10;
    private PollerItem current;
    private DataModel items = null;
    @EJB
    private ua.pp.msk.learn.javaee.cacti.ejb.PollerItemFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public PollerItemController() {
    }

    public PollerItem getSelected() {
        if (current == null) {
            current = new PollerItem();
    ...
    private PollerItemFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (PollerItem) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/PollerItem/Bundle").getString("PollerItemCreated"));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/PollerItem/Bundle").getString("PollerItemDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/PollerItem/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class PollerItemControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            PollerItemController controller = (PollerItemController) facesContext.getApplication().getELResolver().
